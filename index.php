		...
		<header>
			...
			<ul>
				...
				<?php
      			...
      			{
         			?>
        			<li><a href="myprofile.php">Мій профіль</a></li>
         			<li><a href="exit.php">Вийти(<?php echo $_COOKIE['username']; ?>)</a></li>
         			<?php 
      			}	
      			?>
      		</ul>
            ...
            <div id="intro">
                  <p>Наша зуботехнічна лабораторія надає можливість спеціалістам не лише провести якісне лікування, але й перетворити естетичну стоматологію у справжнє мистецтво. Це можливо завдяки професіоналізму зубних техніків і застосуванню високотехнологічного сучасного обладнання – «Ivoclar», «Bredent», «Heraeus», «Kulzer», «Renfert».</p>
                  <p>Високоточне лиття коронок, мостовидних і бюгельних протезів із кобальт-хромових сплавів («Heraenium P», «Duceralloy»). 
                  Ми гарантуємо:</p>
                  <p>- високу якість і точність роботи;</p>
                  <p>- ефективний результат із точки зору естетики та функціональності;</p>
                  <p>- розумну ціну;</p>
                  <p>- короткі строки виготовлення замовлення;</p>
                  <p>Роботи виконуються в артикуляторах STRATOS, PROTAR, AMANN GIRRBACH.</p>
            </div>
